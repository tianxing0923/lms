...
module.exports = function (lmsApp) {
  lmsApp.controller('article.detail', ['$scope', '$sce', '$stateParams', '$location', '$mdDialog', 'message', 'articlesApi', 'commentsApi', function ($scope, $sce, $stateParams, $location, $mdDialog, message, articlesApi, commentsApi) {
    ...
    $scope.submit = function () {
      ...
      commentsApi.add({
        ...
        reference: $scope.comment.articleId,
    ...
    var getDetail = function () {
      articlesApi.detail($stateParams.id).then(function (result) {
        $scope.detail = result;
        getComments();
      });
    };
